    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[#FAF8F5] rounded-3xl border border-[#E7E0D5] w-full max-w-lg shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleProcessPayment} className="p-6 space-y-5">
          ...
          <div className="bg-white p-4 rounded-2xl border border-[#E7E0D5] space-y-3">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-[11px] text-[#8C827A]">Scheduled: {booking.scheduledDate} ({booking.timeSlot})</p>
              </div>
            ...
            <div className="bg-white p-4 rounded-2xl border border-[#E7E0D5] space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs bg-[#FAF7F2] border border-[#DCD3C5] rounded-xl px-3 py-2 text-[#2C2825] focus:ring-1 focus:ring-[#B25E29]"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full text-xs font-mono bg-[#FAF7F2] border border-[#DCD3C5] rounded-xl pl-3 pr-10 py-2 text-[#2C2825] focus:ring-1 focus:ring-[#B25E29]"
                    required
                  />
          ...
          {/* Automated Receipt & Calendar notice */}
          <div className="text-[11px] text-[#7A7168] bg-[#F7F4EE] p-3 rounded-xl border border-[#E8E1D3] space-y-1">
            <div className="flex items-center space-x-1.5 font-semibold text-[#3D3731]">
              <Receipt className="w-3.5 h-3.5 text-[#B25E29]" />
              <span>Automated Transaction Delivery</span>
            </div>
            <p>
              An automated email confirmation receipt will immediately be dispatched to <strong>{booking.customer.email}</strong> and synced with Stevan's calendar at <strong>stevancollinslazich.com</strong>.
            </p>
          </div>
          ...
          >
            {isProcessing ? (
              ...
              <>
                ...
                <span>Pay ${amountToCharge} & Generate Receipt</span>
              </>
            )}
          </button>
        </form>
